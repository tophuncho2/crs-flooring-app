...
import type { TemplateEntityInvolvementRow } from "./types.js"

type TemplateEntityInvolvementInput = {
  id: string
...
export function normalizeTemplateEntityInvolvement(
  item: TemplateEntityInvolvementInput,
