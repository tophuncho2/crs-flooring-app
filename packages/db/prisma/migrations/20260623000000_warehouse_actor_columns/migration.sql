-- ============================================================================
-- FlooringWarehouse: add `createdBy` / `updatedBy` actor-email columns.
--
...
-- user (mirroring the FlooringJobType / FlooringPayment actor precedent — a plain
-- string, no FK).
--
...
--
-- NOTE: FlooringWarehouse createdBy/updatedBy have NO @map, so their real names
-- are camelCase and MUST be double-quoted — an unquoted identifier folds to
-- lowercase.
-- ============================================================================

ALTER TABLE "flooring_warehouse" ADD COLUMN "createdBy" TEXT;
ALTER TABLE "flooring_warehouse" ADD COLUMN "updatedBy" TEXT;
