-- ============================================================================
-- Entity (entity): add `createdBy` / `updatedBy` actor-email columns.
--
...
-- FlooringProduct / Property actor precedent — a plain string, no FK).
--
...
--
-- NOTE: Entity createdBy/updatedBy have NO @map, so their real names are
-- camelCase and MUST be double-quoted — an unquoted identifier folds to
-- lowercase.
-- ============================================================================

ALTER TABLE "entity" ADD COLUMN "createdBy" TEXT;
ALTER TABLE "entity" ADD COLUMN "updatedBy" TEXT;
