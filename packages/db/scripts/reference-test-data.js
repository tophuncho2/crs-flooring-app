...
// UoM names must match SEEDED_UNIT_OF_MEASURES in seed-unit-of-measures.js
const CATEGORY_BLUEPRINTS = [
  {
    ...
    unitNames: {
      send: "Rolls",
      stock: "Rolls",
      coverageAvailable: "Square Feet",
      itemCoverage: "Square Feet",
      service: "Square Feet",
    },
  ...
  },
  {
    ...
    unitNames: {
      send: "Pieces",
      stock: "Pieces",
      coverageAvailable: "Linear Feet",
      itemCoverage: "Linear Feet",
      service: "Linear Feet",
    },
