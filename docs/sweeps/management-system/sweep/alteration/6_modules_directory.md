# Modules Directory — Alterations

## Targeted Module Structure

Each management-system module — **Clients / Properties**, **Clients / Management Companies**, **Main-Hub / Templates**, **User Data / Job Types**, and **Main-Hub / Work Orders** — will conform to the shape already in use by `contacts/`, `manufacturers/`, and `services/` under `apps/web/modules/`.
...
_TBD — to be filled in per module as each current state is audited against the targeted structure._
