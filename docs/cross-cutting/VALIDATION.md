...
- [ROUTE_POLICY.md](../execution/ROUTE_POLICY.md) — `parseMutationEnvelope()` wiring
- [ERROR_HANDLING.md](../execution/ERROR_HANDLING.md) — `AppError` shape and classification
- [EXECUTION_ENGINE.md](../execution/EXECUTION_ENGINE.md) — where validation sits in the 9-step sequence
