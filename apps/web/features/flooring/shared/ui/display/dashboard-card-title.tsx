...
export const DASHBOARD_SURFACE_CARD_CLASS_NAME =
  "w-full overflow-visible rounded-xl border border-[var(--panel-border)] bg-[var(--panel-background)] p-4 shadow-xl sm:p-5"
export const DASHBOARD_SURFACE_HEADER_BLEED_CLASS_NAME =
  "relative z-20 -mx-4 -mt-4 px-4 pt-4 pb-4 sm:-mx-5 sm:-mt-5 sm:px-5 sm:pt-5 sm:pb-5"
