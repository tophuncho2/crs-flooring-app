...
import { RecordLinkedChildTableSection } from "@/features/dashboard/shared/record-view/child-tables/record-linked-child-table-section"
              ...
              <RecordPrimaryFieldsGrid>
                ...
                <RecordPrimaryFieldCell size="lg">
                  <RecordFormField label="Full Address">
                    <RecordStaticFieldValue size="lg">{fullAddress || "Property address preview"}</RecordStaticFieldValue>
                  </RecordFormField>
                </RecordPrimaryFieldCell>
              </RecordPrimaryFieldsGrid>
            </RecordPrimaryPane>
        ...
        <RecordSection>
          <RecordLinkedChildTableSection
            ...
            rows={property.templates.map((template) => ({
              id: template.id,
              primary: template.templateTag,
              context: `${template.warehouseName || "No warehouse"} • ${template.itemsCount} rows`,
            }))}
