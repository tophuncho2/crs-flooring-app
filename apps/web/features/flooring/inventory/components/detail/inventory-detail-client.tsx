...
export function InventoryDetailClient({
  ...
  return (
    <RecordDetailClientScaffold
      ...
      headerMeta={
        <InventoryHeaderMeta
          productName={initialRecord.productName}
          warehouseName={initialRecord.warehouseName}
          importNumber={initialRecord.importNumber}
        />
      }
      headerActions={<InventoryHeaderActions row={initialRecord} />}
    >
      {(page) => (
