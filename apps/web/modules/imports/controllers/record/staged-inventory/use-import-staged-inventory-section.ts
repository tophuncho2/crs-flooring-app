...
export function useImportStagedInventorySection({
  ...
  return {
    ...
    addBlankStagedRow: filters.addBlankStagedRow,
    setStagedRowProductId: filters.setStagedRowProductId,
    setStagedRowProductSnapshot: filters.setStagedRowProductSnapshot,
