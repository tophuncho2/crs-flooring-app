...
export type AddWarehouseButtonProps = {
  onClick: () => void
  disabled?: boolean
}

/**
 * Toolbar action: opens the warehouse side panel in create mode.
 ...
 * the left. Same chrome as `AddPropertyButton` for visual parity across
 * list views.
 */
export function AddWarehouseButton({ onClick, disabled }: AddWarehouseButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
