...
/**
 * Minimal labelled-control wrapper used inside templates record-view
 * groups. Mirrors `WorkOrderField` and the shared `FormField` visual
 * shape, but stays module-local so the groups don't pull in the
 * `FieldSection` placement primitives.
 *
