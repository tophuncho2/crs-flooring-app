...
export type PropertyHubViewPropertiesController = {
  page: number
  totalPages: number
  total: number
...
export function usePropertyHubViewPropertiesQuery(
  managementCompanyId: string | null,
): PropertyHubViewPropertiesController {
  ...
  return useMemo<PropertyHubViewPropertiesController>(() => {
