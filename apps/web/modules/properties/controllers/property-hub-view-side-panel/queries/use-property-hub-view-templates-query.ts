...
export type PropertyHubViewTemplatesController = {
  page: number
  totalPages: number
  total: number
...
export function usePropertyHubViewTemplatesQuery(
  managementCompanyId: string | null,
  selectedPropertyId: string | null,
): PropertyHubViewTemplatesController {
  ...
  return useMemo<PropertyHubViewTemplatesController>(() => {
