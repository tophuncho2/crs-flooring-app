...
import { PaginateControls, ListRowCount, ListToolbar, ListToolbarBottomRow, ListToolbarCell, ListToolbarTallCard, DebouncedSearchControl, ClearAllFiltersButton, ListViewNoticePortal, useFetchListController, LIST_FRESHNESS_STANDARD } from "@/engines/list-view"
...
export default function AdjustmentsClient({
  ...
  return (
    <div className="min-h-screen space-y-3 bg-[var(--background)] px-0 pt-24 pb-12 text-[var(--foreground)] sm:pt-28">
      <ListViewNoticePortal label="Adjustments" />
