...
export function RecordSectionItem({
  ...
  return (
    ...
    >
      ...
      {scopedContent ? (
        <div className={joinRecordSectionClasses("border-t", RECORD_SECTION_BORDER_CLASS_NAME, scopedContentClassName)}>
          {scopedContent}
        </div>
      ) : null}
    </section>
