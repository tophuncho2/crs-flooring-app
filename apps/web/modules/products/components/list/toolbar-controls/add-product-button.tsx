...
/**
 * Toolbar action: routes to the product create page.
 ...
 * the left. Same chrome as `AddPropertyButton` / `AddWarehouseButton` /
 * `AddManufacturerButton` for visual parity across list views.
 */
export function AddProductButton({ onClick, disabled }: AddProductButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
