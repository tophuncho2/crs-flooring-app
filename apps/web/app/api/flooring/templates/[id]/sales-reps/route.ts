...
import { createTemplateSalesRep } from "@/features/flooring/templates/mutations"
import { listTemplateSalesReps } from "@/features/flooring/templates/queries"
import { validateTemplateSalesRepInput } from "@/features/flooring/templates/validators"
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  const rateLimitResponse = await enforceRouteRateLimit(request, access, {
    ...
    limit: 80,
    windowMs: 10 * 60 * 1000,
    route: "/api/flooring/templates/[id]/sales-reps",
  })
