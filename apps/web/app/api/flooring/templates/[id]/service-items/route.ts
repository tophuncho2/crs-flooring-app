...
import { createTemplateServiceItem } from "@/features/flooring/templates/mutations"
import { listTemplateServiceItems } from "@/features/flooring/templates/queries"
import { validateTemplateServiceItemInput } from "@/features/flooring/templates/validators"
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  const rateLimitResponse = await enforceRouteRateLimit(request, access, {
    ...
    limit: 80,
    windowMs: 10 * 60 * 1000,
    route: "/api/flooring/templates/[id]/service-items",
  })
