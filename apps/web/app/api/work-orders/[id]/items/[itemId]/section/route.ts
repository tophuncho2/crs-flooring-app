...
import { saveWorkOrderMaterialSection } from "@/modules/work-orders/mutations"
import { withWorkOrderCapabilities } from "@/modules/work-orders/transport/detail"
import { validateUpdateWorkOrderMaterialSectionInput } from "@/modules/work-orders/validators"
...
export async function PATCH(request: Request, { params }: RouteContext) {
  const access = await applyRoutePolicy(request, {
    ...
    rateLimit: {
      ...
      limit: 80,
      windowMs: 10 * 60 * 1000,
      route: "/api/work-orders/[id]/items/[itemId]/section",
    },
  })
