...
import { saveWorkOrderMaterialItemsSectionUseCase } from "@/modules/work-orders/application/record-sections"
...
import { validateUpdateWorkOrderMaterialItemsSectionInput } from "@/modules/work-orders/validators"
...
export async function PATCH(request: Request, { params }: RouteContext) {
  const access = await applyRoutePolicy(request, {
    ...
    rateLimit: {
      ...
      limit: 80,
      windowMs: 10 * 60 * 1000,
      route: "/api/work-orders/[id]/items/section",
    },
  })
  ...
  try {
    ...
    await withMutationTelemetry(
      ...
      () => saveWorkOrderMaterialItemsSectionUseCase(id, input),
    )
