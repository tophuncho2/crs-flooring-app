...
import { UnitOfMeasureDetailClient } from "@/modules/unit-of-measures/components/record/unit-of-measure-detail-client"
...
export default async function UnitOfMeasureDetailPage({
  ...
  return (
    <UnitOfMeasureDetailClient
      initialUnitOfMeasure={result.data.unitOfMeasure}
