...
describe("package scripts", () => {
  it("keeps Prisma ownership in the db workspace and removes deploy-time migration shortcuts", () => {
    ...
    expect(rootPackageJson.scripts["build:relay"]).toBe("npm run build --workspace @builders/db && npm run build --workspace @builders/domain && npm run build --workspace @builders/lib && npm run build --workspace @builders/relay")
