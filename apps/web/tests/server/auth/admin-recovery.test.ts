...
import { promoteUserToAdmin, resolveAdminRecoveryTarget } from "../../packages/db/scripts/admin-recovery.js"
...
describe("resolveAdminRecoveryTarget", () => {
  ...
  it("rejects missing or invalid args", () => {
    expect(() => resolveAdminRecoveryTarget([])).toThrow(
      "Usage: node scripts/admin-recovery.js <email> or --email <email>",
    )
