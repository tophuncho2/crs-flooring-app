...
import WarehouseClient, { type WarehouseRow } from "@/modules/warehouse/components/warehouse-client"
import { WarehouseDetailClient } from "@/modules/warehouse/record/detail/warehouse-detail-client"
import { createWarehouseDetail } from "@/modules/warehouse/types"
...
describe("WarehouseClient", () => {
  ...
  it("routes warehouse rows into the canonical warehouse detail page", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(
      "/dashboard/warehouse/wh-1?returnTo=%2Fdashboard%2Ftest",
      { scroll: false },
    )
  })
  ...
  it("navigates to the canonical warehouse create page from the list", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(
      "/dashboard/warehouse/new?returnTo=%2Fdashboard%2Ftest",
      { scroll: false },
    )
  })
})
