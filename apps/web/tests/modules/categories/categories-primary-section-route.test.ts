...
import { PATCH } from "@/app/api/categories/[id]/primary/section/route"
...
describe("categories primary section route", () => {
  ...
  it("accepts the mutation envelope and returns the authoritative snapshot", async () => {
    ...
    const response = await PATCH(
      new Request("http://localhost/api/categories/11111111-1111-4111-8111-111111111111/primary/section", {
        method: "PATCH",
