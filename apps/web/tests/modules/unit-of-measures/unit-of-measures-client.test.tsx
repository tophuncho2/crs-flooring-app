...
import UnitOfMeasuresClient from "@/modules/unit-of-measures/components/unit-of-measures-client"
...
describe("UnitOfMeasuresClient", () => {
  ...
  it("dashboard add routes to the canonical unit-of-measure create form", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(
      "/dashboard/unit-of-measures/new?returnTo=%2Fdashboard%2Ftest",
      { scroll: false },
    )
  })
  ...
  it("row click routes to the canonical detail page", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(expect.stringContaining("/dashboard/unit-of-measures/u-1"), { scroll: false })
  })
  ...
  it("detail save validates and uses the engine primary section route", async () => {
    ...
    render(
      <UnitOfMeasureDetailClient
        ...
        canManage
        backHref="/dashboard/unit-of-measures"
      />,
    )
