...
import { normalizeProperty } from "@/modules/properties/services"
...
vi.mock("@/modules/properties/mutations", async () => {
  const actual = await vi.importActual<typeof import("@/modules/properties/mutations")>(
    "@/modules/properties/mutations",
  )
