...
vi.mock("@/modules/shared/engines/common/transport/http", () => ({
...
import { useChildCollection } from "@/modules/shared/engines/record-view/controllers/use-child-collection"
