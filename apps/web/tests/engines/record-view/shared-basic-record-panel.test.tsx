...
vi.mock("@/modules/shared/engines/record-view/forms/record-form", () => ({
  RecordModalShell: ({
    title,
    onClose,
    children,
...
vi.mock("@/modules/shared/engines/record-view/shell/record-panel-footer", () => ({
...
import { BasicRecordPanel } from "@/modules/shared/engines/record-view/shell/basic-record-panel"
