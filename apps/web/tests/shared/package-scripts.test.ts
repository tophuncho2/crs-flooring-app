...
describe("package scripts", () => {
  it("keeps Prisma ownership in the db workspace and removes deploy-time migration shortcuts", () => {
    ...
    expect(rootPackageJson.scripts.test).toBe("npm run test --workspace @builders/domain && npm run test --workspace @builders/application && npm run test --workspace @builders/web && npm run test --workspace @builders/relay && npm run test --workspace @builders/worker")
