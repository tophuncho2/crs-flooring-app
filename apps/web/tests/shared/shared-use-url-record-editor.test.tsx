...
vi.mock("@/modules/shared/engines/common/navigation/url-record-panel", () => ({
  useUrlRecordPanel: () => ({
...
import { useUrlRecordEditor } from "@/modules/shared/engines/common/navigation/use-url-record-editor"
