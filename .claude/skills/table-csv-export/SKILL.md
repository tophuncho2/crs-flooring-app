...
- Add a schema **column** to make something exportable — a missing field is a `/newsession` job (adding `id?` to the filters TYPE for the ticked-rows scope is in scope).
