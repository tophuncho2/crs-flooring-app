...
- **Explicit-only.** Trigger on the literal `/export-csv-sync`. Not on "export this", "download a CSV", "add a download button".
...
- Trigger on anything but the literal `/export-csv-sync` invocation.
