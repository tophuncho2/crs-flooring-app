...
| **Unit of Measures** | Appears as a searchable picker on the product form. Still **seeded / not user-editable** as a list. | n/a | Net-new `/options` search stack mirrors manufacturer picker; clean engine transfer. |
